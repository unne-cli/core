...
const features = [
  { id: 'feature-http', label: 'http' },
  { id: 'feature-tcp', label: 'tcp' },
  { id: 'feature-tui', label: 'tui & inspector' },
  { id: 'feature-config', label: 'config' },
  { id: 'feature-options', label: 'options' },
];

const activeSection = ref('feature-http');
