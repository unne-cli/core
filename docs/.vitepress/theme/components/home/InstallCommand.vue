...
const commandCards: CommandCard[] = [
  {
    id: 'unix',
    label: 'macOS / Linux',
    command: 'curl -fsSL https://unne.site/cli/install | bash',
  },
  {
    id: 'windows',
    label: 'Windows (PowerShell)',
    command: 'irm https://unne.site/cli/install.ps1 | iex',
  },
];
...
<template>
  ...
  >
    <div class="px-5 py-6 sm:p-10 flex flex-col gap-4 justify-center">
      ...
      <h4>Install Unne CLI</h4>
      <p class="max-w-[28rem] text-pretty">
        Install the CLI, open a new terminal, then run <code>unne http 3000</code> to create your first tunnel.
      </p>
      <p class="text-sm text-grey">
        Looking for the server? See the
        <a class="text-primary underline decoration-stroke underline-offset-4" href="/server/">server docs</a>.
      </p>
    </div>
